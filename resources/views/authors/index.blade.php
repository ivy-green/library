            ...
            <tbody>
                @if(count($authors) > 0)
                    ...
                    <tr>
                            ...
                            <td>
                                <a href="./authors/{{$author->id}}"> {{$author->tentacgia}}</a>
                            </td>
                            <td>
                                <a href="./authors/{{$author->id}}"> {{$author->ngaysinh}}</a>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="./authors/{{$author->id}}"> {{$author->soluongsach}}</a>
                            </td>
                            {{-- <td>
                                <button class="btn btn-default">
                                    <a class="btn_a" href="./author/{{$author->id}}">Chỉnh sửa</a>
                                </button>
                                <button class="btn btn-danger">
                                    <a class="btn_a" href="./author/{{$author->id}}">Xóa</a>
                                </button>
                            </td> --}}
                    </tr>
                    @endforeach
