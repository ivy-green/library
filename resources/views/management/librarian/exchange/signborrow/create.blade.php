...
@section('content')
    ...
    <div class="form-main form-border form-hover">
        <h3 class="text-center mb-4">Thêm Phiếu Đăng Ký Mượn Sách</h3>
        {!! Form::open(['action' => 'App\Http\Controllers\SignBorrowController@store', 'files' => true, 'method' => 'POST']) !!}
        <div class="row">
            <div class="col">
        ...
        <div class="book-add-wrapper">
            <div class="form-group">
                {{form::label('', 'Mã phiếu')}}
                {{form::text('', $signbook->id, ['class' => 'form-control', 'placeholder' => 'Nhập tên sách..'])}}
            </div>
            <div class="row">
                <div class="col">
                    <div class="form-group">
