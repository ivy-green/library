...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="/categories">Quản lý sách</a></li>
      <li class="breadcrumb-item"><a href="/categories">Danh mục thể loại</a></li>
      <li class="breadcrumb-item active" aria-current="page">
        <a href="#">Thông tin thể loại</a>
      </li>
    </ol>
  </nav>
